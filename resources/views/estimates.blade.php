...
-->                  
             ...
             <p class="description">
              ウェブのみ（web_only）... ウェブの項目で、アプリの有無で金額が変わる場合選択<br>
              ウェブ含む（web_include）... ウェブの項目で、アプリの有無で金額が変わらない場合選択<br>
              アプリのみ（app_only）... アプリの項目で、ウェブの有無で金額が変わる場合選択<br>
              アプリ含む（app_include）... アプリの項目で、ウェブの有無で金額が変わらない場合選択<br>
              ウェブ+アプリ（web&app）... ウェブ+アプリの項目の場合選択<br>
              端末指定無し（web|app）... ウェブとアプリどちらかの項目で、ウェブ+アプリとしても金額が変わらない場合選択<br>
             </p>
...
-->
             ...
             <p class="description">
              単言語（ja|&eng）... 単言語と両言語で料金が変わるパターンで、単言語の場合選択<br>
              両言語（ja&eng）... 単言語と両言語で料金が変わるパターンで、両言語の場合選択<br>
              言語指定無し（ja|eng）... 単言語と両言語で料金が変わらない場合選択<br>
             </p>                          
<!--             
             <p class="description">
              〇：必ず有り<br>
